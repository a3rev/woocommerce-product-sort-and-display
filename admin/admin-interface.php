			...
			switch( $value['type'] ) {
				...
				case 'manual_check_version':
					...
					?><tr valign="top">
						<th scope="row" class="titledesc">
                        	<?php echo $tip; ?>
							<label><?php echo __( 'Check New Version', 'woocommerce-product-sort-and-display' ); ?></label>
						</th>
						<td class="forminp forminp-manual_check_version">
							...
							<input
                                ...
                                type="button"
								value="<?php echo __( 'Check Now', 'woocommerce-product-sort-and-display' ); ?>"
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-box_shadow">
                            <input
                                    ...
                                    checked_label="<?php _e( 'YES', 'woocommerce-product-sort-and-display' ); ?>"
                                    unchecked_label="<?php _e( 'NO', 'woocommerce-product-sort-and-display' ); ?>"
                                    type="checkbox"
                                    value="1"
                                    <?php checked( 1, $enable ); ?>
                                    <?php echo implode( ' ', $custom_attributes ); ?>
